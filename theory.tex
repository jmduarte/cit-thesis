...
not. The fermions, repersented by left- and right-handed Weyl spinors,
...
& +\overline\ell_\mathrm{L}\tilde\sigma^{\mu}iD_{\mu}\ell_\mathrm{L} +
   ...
   \sigma^{\mu}iD_{\mu}\nu_\mathrm{R} + (\mathrm{h.c.})& \mathrm{(lepton~kinetic~terms)}\nonumber\\
& +\overline q_\mathrm{L}\tilde\sigma^{\mu}iD_{\mu}q_\mathrm{L} +
   ...
   \sigma^{\mu}iD_{\mu}d_\mathrm{R} + (\mathrm{h.c.})& \mathrm{(quark~kinetic~terms)}\nonumber\\
...
quadi-degenerate. To reduce the dimensionality of this parameter
...
$\chip_1 \to \chiz_1 \cPqu \cPaqd$ &  35.1\%\\
$\chip_1 \to \chiz_1 \cPqc \cPaqs$ &  35.1\%\\
$\chip_1 \to \chiz_1 \Pep \PGne$ &  11.7\%\\
$\chip_1 \to \chiz_1 \PGmp \PGnGm$ &  11.7\%\\
$\chip_1 \to \chiz_1 \PGtp \PGnGt$ &  6.4\%
\end{tabular}
