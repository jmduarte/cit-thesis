...
\begin{figure}[htb!]
\centering
\includegraphics[width=0.7\textwidth]{figs/hlt13TeV/HLTRsqMR.pdf}
...
\centering
 \caption{HLT rates and average CPU time consumed for the main and
   backup razor triggers under different running conditions in 2015. Run 260627 had peak $5\times 10^{33}$ cm$^{-2}$
