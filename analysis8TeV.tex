...
algorithm~\cite{btag8TeV}, described in Sec.~\ref{sec:btag}, is used for \PQb-jet tagging. The \PQb-tagging
...
Derived limits on gluino pair production in for different gluino
branching fraction scenarios are presented in
