...
\includegraphics[width=0.9\textwidth]{figs/analysis13TeV/TTBarWJets/MR_TTJetsSingleLepton.pdf}\\
\includegraphics[width=0.9\textwidth]{figs/analysis13TeV/TTBarWJets/MR_WJetsSingleLepton.pdf}
\caption{ The $\MR$ distributions for events in the $\ttbar$ (upper) and $\PW(\ell\nu)$+jets (lower) 
...
\begin{figure}[!ptb] \centering
\includegraphics[width=0.9\textwidth]{figs/analysis13TeV/TTBarWJets/MRRsqWJetsSingleLeptonUnrolledDataMC.pdf}\\
\includegraphics[width=0.9\textwidth]{figs/analysis13TeV/TTBarWJets/Razor_TTBarDileptonCrossCheckRegion_MRRsqUnrolled_MR300Rsq0p15_all_Logy.pdf}
...
\begin{figure}[!ptb] \centering
\subfigure{\includegraphics[width=0.9\textwidth]{figs/analysis13TeV/TTBarWJets/lep1Pt_VetoLeptonControlRegion_Density.pdf}}\\
\subfigure{\includegraphics[width=0.9\textwidth]{figs/analysis13TeV/TTBarWJets/lep1Pt_VetoTauControlRegion_Density.pdf}}
\caption{ The $\pt$ distribution of the veto electron or muon (upper) and the veto $\ensuremath{\tau_{\mathrm{h}}}$ (lower)
...
\caption{The one-dimensional distribution of $\MR$ in the $\cPgg$+jets control region
  (upper) and the two-dimensional $\MR$-$\Rtwo$ distribution in
  the $\cPgg$+jets control region (lower) are shown. The two-dimensional $\MR$-$\Rtwo$ distribution 
