...
published limits in the dijet channel. Finally, the first CMS limits are set on a simplified model of dark matter mediators using the dijet channel, excluding vector and axial-vector mediators
