...
\caption{Representative Feynman diagrams showing the pair production of
  ...
  vector or axial-vector $\PZpr_\mathrm{B}$ mediator. The cross section and kinematics depend on the mediator and dark
...
$\sigma^{\mathrm{SI}}_{\mathrm{DM\textrm{-}\Pp}}$ or $\sigma^{\mathrm{SD}}_{\mathrm{DM\textrm{-}\PN}}$, respectively. The SI
DM-nucleon cross section takes the form~\cite{Boveia:2016mrp}:
\begin{align}
\sigma^{\mathrm{SI}}_{\mathrm{DM\textrm{-}\Pp}}& = \frac{f^2(g^\prime_\Pq) g_\mathrm{DM}^2
...
\begin{align}
\sigma^{\mathrm{SD}}_{\mathrm{DM\textrm{-}\PN}} &= \frac{3f^2(g^\prime_\Pq) g_\mathrm{DM}^2
  \mu_{\PN\chi}}{\pi m_{\mathrm{med}}^4}\\
...
translated into exclusions of the dark matter-nucleon interaction
