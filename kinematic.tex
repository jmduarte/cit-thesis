...
\vec\beta_{\mathrm R} = 0$, we can uniquely specify the boost,
\begin{equation}
\vec\beta_{\mathrm{R}} = 
...
\caption{Distribution of \Rtwo and \MR in the case of squark pair
  ...
  has a larger mean and falls less steeply than the corresponding
...
After forming the megajets, we may compute \MR and $\MRT$, and $\Rtwo$
