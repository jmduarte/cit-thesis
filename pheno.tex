\chapter{Phenomenology of squark-mediated $\PH$+jets production at the LHC}
\label{ch:pheno}
...
observed for certain signal regions, for example, in the case of the dilepton edge analysis by CMS~\cite{CMSedge} and the SUSY
...
\section{Event generation and detector emulation}
\label{sec:gensim}
...
\section{Bayesian statistical procedure}
...
\begin{figure}[htb]\centering
\begin{tabular}{c}
\subfigure{\includegraphics[width=0.9\textwidth]{figs/pheno/obsexp_T21bH_HighRes.pdf}}\\
\subfigure{\includegraphics[width=0.9\textwidth]{figs/pheno/obsexp_T2bH_HighRes.pdf}}
\end{tabular}
\caption{\label{fig:T21bHT2bHExpObs500800} (Top) The expected
  background and its
  ...
  in model A. (Bottom) The expected background and its
  uncertainty (multiplied by a factor of two as explained in the text) compared to the best-fit signal distribution in the \texttt{HighRes} box for two particular
...
\begin{figure}[htb]\centering
\begin{tabular}{c}
\subfigure{\includegraphics[width=0.9\textwidth]{figs/pheno/xsecUL_T21bH_130_100_Total.pdf}}\\
\subfigure{\includegraphics[width=0.9\textwidth]{figs/pheno/xsecUL_T2bH_100_Total.pdf}}
\end{tabular}
...
\begin{figure}[htb]\centering
\begin{tabular}{c}
\subfigure{\includegraphics[width=0.9\textwidth]{figs/pheno/signif_T21bH_130_100_Total.pdf}}\\
\subfigure{\includegraphics[width=0.9\textwidth]{figs/pheno/signif_T2bH_100_Total.pdf}}
\end{tabular}
...
In this appendix, we proposed two simplified models of bottom squark
