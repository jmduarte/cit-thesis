...
in the yield tables in Ref.~\cite{RazorHgaga}, and in Tab.~\ref{tab:bins}.
...
model B as a function of $m_{\sbottom_2}$ as well as the best fit signal cross section.
...
compare both the excluded cross section and the best-fit cross section
...
$m_{\chizone}=130\GeV$. More interestingly, the largest combined significance
