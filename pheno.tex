...
\item Jets are reconstruted using the \FASTJET~\cite{fastjet} implemtnation
...
In this chapter, we put forth two proposals of simiplified models of bottom squark
...
largest signal significance was found to be $2.9\sigma$ for $m_{\sbottom_1}=XXX\GeV$,
$m_{\chiztwo}=XXX\GeV$, and $m_{\chizone}=XXX\GeV$.