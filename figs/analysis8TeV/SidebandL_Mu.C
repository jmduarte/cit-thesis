...
//=========  (Tue Jan 20 19:45:16 2015) by ROOT version5.34/21
   ...
   graph->SetPoint(0,300.0000068,0.1499999931);
   graph->SetPoint(1,300.0000068,0.2000543901);
   graph->SetPoint(2,348.7435112,0.2000543901);
   graph->SetPoint(3,348.7435112,0.1499999931);
   graph->SetPoint(4,300.0000068,0.1499999931);
   ...
   graph->SetPoint(0,300.0000068,0.2000543901);
   graph->SetPoint(1,449.3079364,0.2000543901);
   graph->SetPoint(2,449.3079364,1.501571498);
   graph->SetPoint(3,300.0000068,1.501571498);
   graph->SetPoint(4,300.0000068,0.2000543901);
   ...
   graph->SetFillColor(ci);
   graph->SetPoint(0,348.7435112,0.1499999931);
   graph->SetPoint(1,3994.129114,0.1499999931);
   graph->SetPoint(2,3994.129114,0.2000543901);
   graph->SetPoint(3,348.7435112,0.2000543901);
   graph->SetPoint(4,348.7435112,0.1499999931);
   ...
   graph->SetFillColor(ci);
   graph->SetPoint(0,449.3079364,0.2000543901);
   graph->SetPoint(1,3994.129114,0.2000543901);
   graph->SetPoint(2,3994.129114,1.501571498);
   graph->SetPoint(3,449.3079364,1.501571498);
   graph->SetPoint(4,449.3079364,0.2000543901);
   ...
   graph->Draw("f");
   line = new TLine(300,0.15,4000,0.15);
   line->SetLineWidth(2);
   line->Draw();
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(300,0.15,300,1.5);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(300,1.5,450,1.5);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(4000,0.15,4000,0.15);
   line->SetLineWidth(2);
   line->Draw();
   TLatex *   tex = new TLatex(250,0.75,"0.8");
   tex->SetTextFont(42);
   ...
   TLegendEntry *entry=leg->AddEntry("Graph1","Low M_{R} sideband: 300 < M_{R} < 450 GeV and R^{2} > 0.2","F");
   ...
   entry=leg->AddEntry("Graph2","Low R^{2} sideband: M_{R} > 350 GeV and 0.15 < R^{2} < 0.2","F");
