...
//=========  (Wed Jul 27 16:07:57 2016) by ROOT version5.34/31
   ...
   graph->SetPoint(0,500,6.357487923);
   graph->SetPoint(1,550,6.634812287);
   graph->SetPoint(2,600,6.23580786);
   graph->SetPoint(3,650,5.46701847);
   graph->SetPoint(4,700,3.848580442);
   graph->SetPoint(5,750,3.071161049);
   graph->SetPoint(6,800,2.873362445);
   graph->SetPoint(7,850,2.865822785);
   graph->SetPoint(8,900,2.920821114);
   graph->SetPoint(9,950,2.922558923);
   graph->SetPoint(10,1000,2.812260536);
   graph->SetPoint(11,1050,2.640692641);
   graph->SetPoint(12,1100,2.425120773);
   graph->SetPoint(13,1150,2.237837838);
   graph->SetPoint(14,1200,2.115151515);
   graph->SetPoint(15,1250,2.020134228);
   graph->SetPoint(16,1300,1.977777778);
   graph->SetPoint(17,1350,2.008264463);
   graph->SetPoint(18,1400,1.972972973);
   graph->SetPoint(19,1450,1.97029703);
   graph->SetPoint(20,1500,1.967741935);
   graph->SetPoint(21,1550,2.011764706);
   graph->SetPoint(22,1600,2.090909091);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Graph",100,390,1710);
   Graph_Graph1->SetMinimum(1.501035);
   Graph_Graph1->SetMaximum(7.101519);
   ...
   graph->SetPoint(0,500,5.08881014);
   graph->SetPoint(1,550,7.666021659);
   graph->SetPoint(2,600,4.995967452);
   graph->SetPoint(3,650,4.805716874);
   graph->SetPoint(4,700,3.534857626);
   graph->SetPoint(5,750,2.914976981);
   graph->SetPoint(6,800,2.227312023);
   graph->SetPoint(7,850,1.852176247);
   graph->SetPoint(8,900,1.791495684);
   graph->SetPoint(9,950,2.060089872);
   graph->SetPoint(10,1000,2.811397794);
   graph->SetPoint(11,1050,2.314431662);
   graph->SetPoint(12,1100,1.847037609);
   graph->SetPoint(13,1150,1.774889235);
   graph->SetPoint(14,1200,1.790642733);
   graph->SetPoint(15,1250,1.844473194);
   graph->SetPoint(16,1300,1.819945033);
   graph->SetPoint(17,1350,1.729817305);
   graph->SetPoint(18,1400,1.598987887);
   graph->SetPoint(19,1450,1.502942671);
   graph->SetPoint(20,1500,1.475498174);
   graph->SetPoint(21,1550,1.474884436);
   graph->SetPoint(22,1600,1.521009351);
   
   TH1F *Graph_Graph2 = new TH1F("Graph_Graph2","Graph",100,390,1710);
   Graph_Graph2->SetMinimum(0.8557707);
   Graph_Graph2->SetMaximum(8.285135);
   ...
   Graph_Graph_Graph13->SetMinimum(1.501035);
   Graph_Graph_Graph13->SetMaximum(7.101519);
   ...
   Graph_Graph_Graph24->SetMinimum(0.8557707);
   Graph_Graph_Graph24->SetMaximum(8.285135);
