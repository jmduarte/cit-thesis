...
//=========  (Sat Oct 29 11:10:20 2016) by ROOT version5.34/31
   ...
   graph->SetPoint(1,650,0.0006846005613);
   graph->SetPoint(2,700,0.00107931131);
   graph->SetPoint(3,750,0.4555133579);
   graph->SetPoint(4,800,1.578836744);
   graph->SetPoint(5,850,2.583726697);
   graph->SetPoint(6,900,2.533693559);
   graph->SetPoint(7,950,1.653569861);
   graph->SetPoint(8,1000,0.2295332348);
   ...
   graph->SetPoint(17,1450,0.000396288953);
   ...
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Graph",100,500,1700);
   Graph_Graph1->SetMinimum(0);
   Graph_Graph1->SetMaximum(2.842099);
   Graph_Graph1->SetDirectory(0);
   Graph_Graph1->SetStats(0);
   ...
   Graph_Graph_Graph12->SetMaximum(2.842099);
...
tex->SetNDC();
   ...
   Graph_Graph_Graph_Graph123->SetMaximum(2.842099);
