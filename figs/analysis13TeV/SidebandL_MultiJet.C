...
//=========  (Wed Jan 21 13:25:26 2015) by ROOT version5.34/21
   ...
   c2->SetFrameBorderMode(0);
   Double_t xAxis1[8] = {500, 600, 700, 900, 1200, 1600, 2500, 4000}; 
   Double_t yAxis1[7] = {0.25, 0.3, 0.41, 0.52, 0.64, 0.8, 1.5}; 
   
   TH2D *hNS = new TH2D("hNS","Hadronic boxes",7, xAxis1,6, yAxis1);
   hNS->SetMinimum(-5.1);
   hNS->SetMaximum(5.1);
   hNS->SetStats(0);
   hNS->SetContour(3);
   ...
   line->SetLineStyle(2);
   line->Draw();
   line = new TLine(500,0.8,4000,0.8);
   line->SetLineColor(17);
   line->SetLineStyle(2);
   line->Draw();
   ...
   line->SetLineStyle(2);
   line->Draw();
   line = new TLine(650,0.25,650,1.5);
   line->SetLineColor(17);
   line->SetLineStyle(2);
   line->Draw();
   ...
   graph->SetPoint(1,500.,0.3);
   graph->SetPoint(2,600.,0.3);
   graph->SetPoint(3,600.,0.25);
   ...
   graph->SetFillColor(ci);
   graph->SetPoint(0,600,0.3);
   graph->SetPoint(1,4000,0.3);
   graph->SetPoint(2,4000,1.5);
   graph->SetPoint(3,600,1.5);
   graph->SetPoint(4,600,0.3);
   ...
   graph->Draw("f");
   line = new TLine(500,0.25,4000,0.25);
   line->SetLineWidth(2);
   line->Draw();
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(500,0.25,500,1.5);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(500,1.5,600,1.5);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(4000,0.25,4000,0.25);
   line->SetLineWidth(2);
   line->Draw();
   TLatex *   tex = new TLatex(432,0.76,"0.8");
   tex->SetTextFont(42);
   tex->SetTextSize(0.065);
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(432,0.47,"0.5");
   tex->SetTextFont(42);
   tex->SetTextSize(0.065);
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(432,0.285,"0.3");
   tex->SetTextFont(42);
   tex->SetTextSize(0.065);
   tex->SetLineWidth(2);
   tex->Draw();
   ...
   TLegendEntry *entry=leg->AddEntry("Graph1","Low M_{R} sideband: 500 < M_{R} < 600 GeV and R^{2} > 0.3","F");
   ...
   entry=leg->AddEntry("Graph2","Low R^{2} sideband: M_{R} > 500 GeV and 0.25 < R^{2} < 0.3","F");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("Graph3","Signal-sensitive region: M_{R} > 600 GeV and R^{2} > 0.3","F");
   ...
   text = pt->AddText("Hadronic categories");
   pt->Draw();
   c2->Modified();
   c2->cd();
   c2->SetSelected(c2);
   c2->SaveAs("SidebandL_MultiJet.pdf");
