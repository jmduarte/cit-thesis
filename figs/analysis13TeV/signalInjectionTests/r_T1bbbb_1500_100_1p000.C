...
//=========  (Fri Dec  4 09:45:27 2015) by ROOT version5.34/31
   ...
   c->Range(-1.479042,-113.5063,3.311377,832.3798);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   rHist->SetBinContent(8,1);
   rHist->SetBinContent(9,7);
   rHist->SetBinContent(10,14);
   rHist->SetBinContent(11,27);
   rHist->SetBinContent(12,59);
   rHist->SetBinContent(13,64);
   rHist->SetBinContent(14,128);
   rHist->SetBinContent(15,181);
   rHist->SetBinContent(16,254);
   rHist->SetBinContent(17,327);
   rHist->SetBinContent(18,343);
   rHist->SetBinContent(19,396);
   rHist->SetBinContent(20,392);
   rHist->SetBinContent(21,427);
   rHist->SetBinContent(22,322);
   rHist->SetBinContent(23,283);
   rHist->SetBinContent(24,213);
   rHist->SetBinContent(25,170);
   rHist->SetBinContent(26,132);
   rHist->SetBinContent(27,113);
   rHist->SetBinContent(28,70);
   rHist->SetBinContent(29,40);
   rHist->SetBinContent(30,29);
   rHist->SetBinContent(31,13);
   rHist->SetBinContent(32,8);
   rHist->SetBinContent(33,3);
   rHist->SetBinContent(34,2);
   rHist->SetBinContent(36,3);
   rHist->SetBinContent(37,1);
   rHist->SetBinContent(40,1);
   rHist->SetMaximum(747.25);
   rHist->SetEntries(4027);
