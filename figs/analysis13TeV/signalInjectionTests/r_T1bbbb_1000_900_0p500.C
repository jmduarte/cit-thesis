...
//=========  (Fri Dec  4 09:43:31 2015) by ROOT version5.34/31
   ...
   c->Range(-1.979042,-9.303798,2.811377,68.22785);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   rHist->SetBinContent(11,3);
   rHist->SetBinContent(12,4);
   rHist->SetBinContent(13,6);
   rHist->SetBinContent(14,11);
   rHist->SetBinContent(15,9);
   rHist->SetBinContent(16,13);
   rHist->SetBinContent(17,14);
   rHist->SetBinContent(18,23);
   rHist->SetBinContent(19,25);
   rHist->SetBinContent(20,24);
   rHist->SetBinContent(21,32);
   rHist->SetBinContent(22,35);
   rHist->SetBinContent(23,27);
   rHist->SetBinContent(24,24);
   rHist->SetBinContent(25,30);
   rHist->SetBinContent(26,16);
   rHist->SetBinContent(27,16);
   rHist->SetBinContent(28,11);
   ...
   rHist->SetBinContent(35,3);
   rHist->SetBinContent(36,2);
   rHist->SetMaximum(61.25);
   rHist->SetEntries(354);
