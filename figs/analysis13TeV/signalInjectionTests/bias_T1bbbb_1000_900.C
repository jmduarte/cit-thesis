...
//=========  (Fri Dec  4 09:43:32 2015) by ROOT version5.34/31
   ...
   gre->SetPoint(0,0,0.07537264);
   gre->SetPointError(0,0,0.5134496);
   gre->SetPoint(1,0.5,0.6243109);
   gre->SetPointError(1,0,0.5079411);
   gre->SetPoint(2,1,1.030052);
   gre->SetPointError(2,0,0.6014276);
   gre->SetPoint(3,2,2.084282);
   gre->SetPointError(3,0,0.7745706);
   gre->SetPoint(4,5,5.122323);
   gre->SetPointError(4,0,1.006068);
   gre->SetPoint(5,10,10.26994);
   gre->SetPointError(5,0,1.124459);
   
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","Graph",100,0,11);
   Graph_Graph1->SetMinimum(-1.621324);
   Graph_Graph1->SetMaximum(12.57764);
