...
searches go beyond the ``simplified model'' paradigm by interpretting results in a broader natural SUSY
...
$\PH(\Pgg\Pgg)+$jet events. We reinterpretted the results of an
