...
\caption{ Timing measurement schematic breakdown using a monolithic, large scintillating crystal~\cite{NIMA}. 
...
basic detector elements~\cite{NIMA}. One photodetector is used as a time reference and the second 
...
recorded using  8\GeV electron beam~\cite{NIMA}.} 
...
\caption{ Sample fits used to assign timestamps to digitized MCP-PMT pulses~\cite{NIMA}. 
...
on the left, along with a picture of the experimental setup shown on the right~\cite{NIMA}. } 
...
for 4 \GeV (top left), 8 \GeV (top right), 16 \GeV (bottom left), and 32 \GeV (bottom right) electron beam energy~\cite{NIMA}. } 
...
misconfiguration of the \v{C}erenkov counter~\cite{NIMA}. } 
...
using DSB1 fibers for 4 \GeV (top left), 8 \GeV (top right), 16 \GeV (bottom left), and 32 \GeV (bottom right) electron beam energy~\cite{NIMA}.} 
...
with a picture of the experimental setup~\cite{NIMA}. } 
...
for 8 \GeV (top left), 16 \GeV (top right), and 32 \GeV (bottom) electron beam energy~\cite{NIMA}. } 
...
and the LYSO-tungsten shashlik calorimeter with light extracted using DSB1 fibers (red)~\cite{NIMA}. 
